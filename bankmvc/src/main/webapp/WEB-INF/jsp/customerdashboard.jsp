...
<body class="doodle">
	...
	<br>
		...
		<table border="2" cellpadding="5" class="table container table-striped">
			<tr >
				<th>CUSTOMER ID</th>
				<th>CUSTOMER NAME</th>
				<th>DOB</th>
	...
	<div class="row container justify-content-around">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 9em 120em 14em 14em;">
				...
				<img alt="" class="card-img-top" src="/Images/withdraw.jpg" style="height:200px">
					<div class="card-body">
						...
						<form:form action="/withdraw" method="post" modelAttribute="accountinput">
							...
							<form:input type="number" path="amount" name="amount" placeholder="Enter the amount" min="100" />
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 9em 120em 14em 14em;">
				<div class="card bg-dark text-white" style="width: 500px; background-color: #f3d8d8">
					<img alt="" class="card-img-top" src="/Images/trans1.png" style="height:200px">
					<div class="card-body">
						<h4 class="card-title">Transfer Amount</h4>
						<form:form class="container" action="/transfer" method="post" modelAttribute="accountinput">
						<label>From Account:</label>
						<form:select path="accountId" name="accountId">
								<c:forEach var="acc" items="${customer.accounts}">
								<form:option value="${acc.accountId }"></form:option>
